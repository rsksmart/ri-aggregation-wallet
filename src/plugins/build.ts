...
export const APP_ZKSYNC_BLOCK_EXPLORER: string = IS_LOCALHOST ?`${APP_ZK_SCAN}` : `${APP_ZK_SCAN}/explorer`;
export const APP_ETH_BLOCK_EXPLORER: string = IS_LOCALHOST ? `http://localhost:7001` : `https://${ETHER_PREFIX_DOT}etherscan.io`;
export const EXPLORER_TX: string = IS_LOCALHOST ? '/transactions/' : '/tx/';
/**
 * Onboard-only params
 */
