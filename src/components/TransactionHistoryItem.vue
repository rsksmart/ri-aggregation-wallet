  ...
  <div class="transaction">
    ...
    <div>
      <i-tooltip placement="bottom-start" class="status">
        ...
        <template #body>Rollup explorer transaction</template>
      </i-tooltip>
      <i-tooltip placement="bottom-start" class="status">
        <div>
          <a
            ...
            :class="
              isTransactionVerified() ? 'button -md -secondary -link' : 'disabled_link button -md -secondary -link'
            "
        ...
        <template #body>{{ getL1TooltipText() }}</template>
      </i-tooltip>
    </div>
  </div>
</template>
