...
import { APP_ZKSYNC_BLOCK_EXPLORER, ETHER_NETWORK_NAME, EXPLORER_ZK_TX } from "@/plugins/build";
...
export default Vue.extend({
  ...
  methods: {
    ...
    async withdraw(): Promise<void> {
      ...
      this.transactionInfo.explorerLink = APP_ZKSYNC_BLOCK_EXPLORER + EXPLORER_ZK_TX + this.transactionInfo.hash;
